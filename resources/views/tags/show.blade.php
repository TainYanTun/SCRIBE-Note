        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-[#282828] overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-100">
                    ...
                    <p class="text-sm text-gray-400">Slug: {{ $tag->slug }}</p>
                    <p class="text-sm text-gray-400">Created: {{ $tag->created_at->format('M d, Y H:i') }}</p>
                    <p class="text-sm text-gray-400">Last updated: {{ $tag->updated_at->format('M d, Y H:i') }}</p>
